...
// router.get("/users", admin.GET_ALL_USERS);
// router.delete("/users/:userId", admin.REMOVE_USER);
// router.patch("/users/:userId", admin.UPDATE_USER);
...
// staff-login
// //////////////////////////////////////////////////////////////
// router.post("/register", staff.REGISTER_STAFF);
...
// staff - complaints
// //////////////////////////////////////////////////////////////
// router.get("/complaints", staff.GET_ALL_COMPLAINTS);
// router.get(
//   "/complaints/pending",
//   staffComplaintsControllers.GET_ALL_PENDING_COMPLAINTS
// );
// router.patch(
//   "/complaints/update/:_complaintId",
//   staffComplaintsControllers.MANAGE_STATUS
// );
// router.get(
//   "/complaints/:_complaintId",
//   staffComplaintsControllers.GET_COMPLAINT
// );
// staff - demands
// ////////////////////////////////////////////////////////////
...
// router.get(
//   "/demands/pending",
//   complaintsDemandsControllers.GET_ALL_PENDING_DEMANDS
// );
// router.get("/demands/:demandId", demandedMoviesController.GET_DEMAND);
// router.patch("/demands/:demandId", complaintsDemandsControllers.EDIT_DEMANDS);
// ! ///////////////////// staff end //////////////////////////////////
// !======================================================================
// !======================================================================
// !======================================================================
...
// user - search
// ////////////////////////////////////////////////////////////
// router.get("/movies/search", user.SEARCH_MOVIES);
...
// router.get("/user/feedback/movie/:id", checkAuth, user.GET_MOVIE_FEEDBACK);
// router.patch("/user/feedback/:id/:movie", checkAuth, user.U);
// router.patch("/payments/:userId", user.CANCEL_PAYMENTS);
